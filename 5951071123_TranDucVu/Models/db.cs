...
namespace _5951071123_TranDucVu.Models
{
    public class db
   {
        SqlConnection con = new SqlConnection(@"Data Source = DESKTOP - G6K7MET\SQLEXPRESS;Initial Catalog = DemoCRUD.; Integrated Security = True");
